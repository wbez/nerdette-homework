...
**TKTK: Describe nerdette-homework here.**
...
```
cd nerdette-homework
mkvirtualenv nerdette-homework
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=18dX9YPz6O5dDkeAAc8Gp6noal35yUTi9ck__qRYQl6A#gid=0).
...
def read_my_google_doc():
    ...
    get_document('18dX9YPz6O5dDkeAAc8Gp6noal35yUTi9ck__qRYQl6A', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/nerdette_homework/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|nerdette-homework|tweet|`location`||
|nerdette-homework|facebook|`location`||
|nerdette-homework|email|`location`||
|nerdette-homework|new-comment||
|nerdette-homework|open-share-discuss||
|nerdette-homework|close-share-discuss||
|nerdette-homework|summary-copied||
|nerdette-homework|featured-tweet-action|`action`|
|nerdette-homework|featured-facebook-action|`action`|
