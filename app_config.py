...
PROJECT_SLUG = 'nerdette-homework'

# Project name to be used in file paths
PROJECT_FILENAME = 'nerdette_homework'

# The name of the repository containing the source
REPOSITORY_NAME = 'nerdette-homework'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1M4ViIf_x16MAHLZKMC9CERCVL00XomWbThrsM2L2wT0'
